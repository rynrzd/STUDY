...
try {
  ...
  if (CIBLE === "") {
    ...
    for (const [nom, script] of [
      ...
      ["barriere d origine sur les mutations", "verifier:origine"],
      ["aucun secret dans ce qui est servi", "verifier:fuites"],
      ["lieu de calcul et lieu de la base", "verifier:hebergement"],
